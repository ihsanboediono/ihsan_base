								...
								<div class="card-body">
                                    <form action="{{ route('admin.product.store') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name_id" name="name_id" placeholder="Nama produk" value="{{ old('name_id') }}">
                                            @error('name_id') <span class="text-danger">{{ $message }}</span> @enderror
                                        </div>
                                        {{-- <div class="form-group">
                                            <label for="name_en">Nama produk (English)</label>
                                            <input type="text" class="form-control" id="name_en" name="name_en" placeholder="Nama produk bahasa inggris" value="{{ old('name_en') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="category" name="category">
                                                ...
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}">{{ $category->title_id }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <button class="btn btn-primary btn-rounded" type="submit">Tambah produk </button>
