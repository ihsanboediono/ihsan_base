						...
						<div class="col-md-8">
							<div class="card">
                                <div class="card-header card-info">
                                    <div class="card-title">Form tambah penghargaan</div>
                                </div>
								<div class="card-body">
                                <form action="{{ route('admin.award.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label for="name_id">Nama penghargaan</label>
                                        <input type="text" class="form-control" id="name_id" name="name_id" placeholder="Nama penghargaan" value="{{ old('name_id') }}">
                                        @error('name_id') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    {{-- <div class="form-group">
                                        <label for="name-eng">Nama penghargaan (english)</label>
                                        <input type="text" class="form-control" id="name_en" name="name_en" placeholder="Judul penghargaan bahasa inggris" value="{{ old('name_en') }}">
                                        @error('name_en') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div> --}}
                                    <div class="form-group">
                                        <label for="description_id">Deskripsi penghargaan</label>
                                    ...
                                    {{-- <div class="form-group">
                                        <label for="description_en">Deskripsi penghargaan (English)</label>
                                    ...
                                    <div>
                                        <button class="btn btn-primary btn-rounded">Tambah penghargaan </button>
