						...
						<div class="col-md-8">
							<div class="card">
                                <div class="card-header card-info">
                                    <div class="card-title">Tambah laporan tahunan</div>
                                </div>
								<div class="card-body">
                                <form action="{{ route('admin.report.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title_id" name="title_id" placeholder="Judul laporan tahunan" value="{{ old('title_id') }}">
                                        @error('title_id') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    {{-- <div class="form-group">
                                        <label for="title_en">Judul laporan tahunan (english)</label>
                                        <input type="text" class="form-control" id="title_en" name="title_en" placeholder="Judul laporan tahunan bahasa inggris" value="{{ old('title_en') }}">
                                    ...
                                    <div class="form-group col-md-8">
                                        <p style="font-weight: 600">File laporan tahunan</p>
                                    ...
                                    <button class="btn btn-primary btn-rounded">Tambah laporan tahunan</button>
