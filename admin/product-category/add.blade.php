								...
								<div class="card-body">
                                    <form action="{{ route('admin.product.category.store') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="name_id">Kategori Produk</label>
                                            <input type="text" class="form-control" id="name_id" name="name_id" placeholder="Nama kategori produk" value="{{ old('name_id') }}">
                                            @error('name_id') <span class="text-danger">{{ $message }}</span> @enderror
                                        </div>
                                        {{-- <div class="form-group">
                                            <label for="name_id">Nama Kategori Produk (English)</label>
                                            <input type="text" class="form-control" id="name_id" name="name_en" placeholder="Nama kategori produk bahasa inggris" value="{{ old('name_id') }}">
                                            @error('name_en') <span class="text-danger">{{ $message }}</span> @enderror
                                        </div> --}}
                                        <button class="btn btn-primary btn-rounded" type="submit">Tambah Kategori</button>
