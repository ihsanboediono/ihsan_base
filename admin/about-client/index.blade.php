                ...
                <div class="panel-header bg-primary-gradient">
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="text-white pb-2 fw-bold">Client Pt BASE</h2>
                                <h5 class="text-white op-7 mb-2">Kelola informasi tentang client perusahaan dengan mudah disini</h5>
                            </div>
                            <div class="ml-md-auto py-2 py-md-0">
                                <a href="{{ route('admin.client.add') }}" class="btn btn-secondary btn-round"><i class="fa fa-plus-circle mr-2" aria-hidden="true"></i>Tambah Client</a>
                            </div>
                        </div>
                    </div>
                </div>
			...
			table =  $('#basic-datatables').DataTable({
				...
				columns: [
					...
					{ data: 'link' },
					{
						data: 'id',
						render: function(data, type, row){
							var url_edit = "{{url('/admin/client/edit')}}"+"/"+data;
							return '\
							<a href="'+url_edit+'" class="btn btn-xs btn-warning my-1">Edit</a>\
							<button class="btn btn-xs btn-danger my-1" id="delete"  onclick="delete_data('+data+', \'client\')">Hapus</button>';
						}
					},
				]
			});
