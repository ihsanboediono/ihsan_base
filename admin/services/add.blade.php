						...
						<div class="col-md-8">
							<div class="card">
                                <div class="card-header card-info">
                                    <div class="card-title">Form tambah layanan baru</div>
                                </div>
								<div class="card-body">
                                <form action="{{ route('admin.service.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name_id" name="name_id" placeholder="Nama layanan" value="{{ old('name_id') }}">
                                        @error('name_id') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    {{-- <div class="form-group">
                                        <label for="name_en">Nama layanan (English)</label>
                                        <input type="text" class="form-control" id="name_en" name="name_en" placeholder="Nama layanan bahasa inggris" value="{{ old('name_en') }}">
                                    ...
                                    {{-- <div class="form-group">
                                        <label for="description_id">Deskripsi layanan (English)</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <img class="img-fluid mb-3 icon-preview" id="iconx" style="display: none">
                                            <p id="icon-name"></p>
                                            <label class="image-label" for="icon"><i class="fas fa-file-upload"></i><span>Cari File</span></label>
                                            <input type="file" class="form-control-file" id="icon" name="icon" onchange="previewIcon()" style="display:none">
                                            <div class="info">
                                                <p>Max size : 1MB</p>
                                            </div>
                                    ...
                                    <button class="btn btn-primary btn-rounded">Tambah layanan </button>
